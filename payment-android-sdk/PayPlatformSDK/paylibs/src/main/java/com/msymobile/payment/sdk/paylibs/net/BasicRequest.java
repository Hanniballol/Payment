...
import com.msymobile.payment.sdk.paylibs.net.able.Cancelable;
import com.msymobile.payment.sdk.paylibs.net.able.Finishable;
import com.msymobile.payment.sdk.paylibs.net.able.Startable;
import com.msymobile.payment.sdk.paylibs.net.tools.CounterOutputStream;
import com.msymobile.payment.sdk.paylibs.net.tools.IOUtils;
import com.msymobile.payment.sdk.paylibs.net.tools.LinkedMultiValueMap;
import com.msymobile.payment.sdk.paylibs.net.tools.MultiValueMap;
...
//        mHeaders.set(Headers.HEAD_KEY_USER_AGENT, UserAgent.instance());
        ...
        mParams = new LinkedMultiValueMap<String,Object>();
